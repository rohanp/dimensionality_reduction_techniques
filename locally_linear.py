...
class LocallyLinearEmbedding(BaseEstimator, TransformerMixin):
    ...
    evecs_ : array[float, float], shape=(n_dim, n_samples) 
		Sorted eigenectors, descending order 

	evals_ : array[float], shape=(n_dim) 
    ...
    def _fit_transform(self, X):
        ...
        X = check_array(X)
        self.nbrs_.fit(X)
        self.embedding_, self.evals_, self.evecs_ = \
